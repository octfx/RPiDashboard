...
;(function($) {
    ...
    $.fn.openWeather  = function(options) {
        ...
        apiURL = 'http://api.openweathermap.org/data/2.5/weather?lang='+s.lang+'&units=metric';
        ...
        $.ajax({
	        ...
	        success: function(data) {
	        	...
	        	if(s.windSpeedTarget != null) {
		        	...
		        	//set wind speed
		        	$(s.windSpeedTarget).text(Math.round(data.wind.speed) + ' Km/h');
	        	}
	        	...
	        	if(s.sunriseTarget != null) {
		        	...
		        	//set humidity
		        	$(s.sunriseTarget).text(sunrise+' Uhr');
	        	}
	        	...
	        	if(s.sunsetTarget != null) {
		        	...
		        	//set humidity
		        	$(s.sunsetTarget).text(sunset+' Uhr');
	        	}
